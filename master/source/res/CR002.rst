...
#. Les capteurs de passage dans le sol sont utilisé pour détecter la sortie ou l'entrée d'un véhicule avant de refermer la barrière
...
#. Par exemple l'administrateur des personnels d'une Maison du Département en les ajoutant au groupe via leur badge et définir les niveaux auxquelles elles ont accès et à quels moments. 
