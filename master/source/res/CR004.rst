...
#. Les gardiens seront équipés de tablettes sous Chrome pour gérer les incidents.
...
#. _
#. Le poste superviseur (toujours un seul, pour des raisons de sécurité) et les postes administrateurs (autant que nécessaire) seront connectés au serveur applicatif par une liaison Ethernet, avec unun interface WEB utilisant le protocole https.
#. Il s'agit dans les deux cas de PCs sous Windows.
#. _
#. Les administrateurs gèrent les personnels et leurs inscriptions à des groupes, mais pas aussi leurs changements de véhicule.
