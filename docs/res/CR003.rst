...
#. La borne peut émettre (en entrée) et lire (en sortie) des tickets de stationnement utilisant des QR codes qui ressemblent *par certains aspects* à celui à gauche sur la figure 2 ci-dessous

    .. _CR004Fig2:

    .. figure:: media/tickets.jpeg
        :align: center
	:scale: 10%
...
#. Ce justificatif CB est similaire *par certains aspects* à celui à droite sur la figure 2 (voir plus haut)
